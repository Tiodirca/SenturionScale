class Textos {
  ...
  static String descricaoCriarTabela =
      "Digite aqui o nome que a escala irá conter,"
      " para estar criando a mesma no banco de dados.";
  static String labelNomeTabela = "Nome Escala";
